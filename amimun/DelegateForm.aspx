...
<p>
<b>PLEASE ANSWER ONE OF THE FOLLOWING QUESTIONS AND INDICATE YOUR CHOICE OF QUESTION :</b>
</p>

<p>
<asp:RadioButtonList ID="rdbans" runat="server" style="float:left;margin-left:-90px;">
 <asp:ListItem Text="OPINION THE GLOBAL DIPLOMATIC DISTRESS CAUSED BY THE QATAR-GULF CRISIS <br /><br />OR<br />" Selected="true" Value="1" style="margin-left:-50px;"> 
 </asp:ListItem>
 <asp:ListItem Text="ESTABLISH YOUR STAND ON CULTURAL GENOCIDE AND HEGEMONY EFFECTING HUMANITY" Value="2"></asp:ListItem>
</asp:RadioButtonList>
...
<p style="text-align:right;">Max: 5000 characters</p>
