<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IPThankyou.aspx.cs" Inherits="IPThankyou" %>
...
<head>
	...
	<!-- Pre-load Images -->
	<img src="images/menu-logo-blue.png" style="display: none;" alt=""/>
	<img src="images/pdf_blue.png" style="display: none;" alt=""/>
...
<section class = 'oxwrapper'>
 ...
 <center>
     <span style="font-family:Monotype Corsiva;font-size:40px;font-weight:bold;">Payment's Detail</span>
    </center>
      <hr /><br />
      
     <table border="0" cellpadding="1" cellspacing="0" align="center" width="100%" style="font-family:Verdana;font-size:12px;margin-left:0px; color:White;background-color:blue;">
       <tr><td colspan="2">&nbsp;</td></tr>
       <tr>
       <td width="50%" align="right"><asp:Label ID="lblRegHead" runat="server" Text="Registration No. :" Visible="false"></asp:Label></td>
       <td width="50%" align="left"><asp:Label ID="lblRegNo" runat="server" Visible="false"></asp:Label></td>
       </tr> 
       
       <tr><td colspan="2">&nbsp;</td></tr>
       <tr>
       <td width="50%" align="right"><asp:Label ID="lblTranHead" runat="server" Text="Transaction No. :" Visible="false"></asp:Label></td>
       <td width="50%" align="left"><asp:Label ID="lblTranNo" runat="server" Visible="false"></asp:Label></td>
       </tr>      
       
       <tr><td colspan="2">&nbsp;</td></tr>
       <tr>
       <td width="50%" align="right"><asp:Label ID="lblAmtHead" runat="server" Text="Amount :" Visible="false"></asp:Label></td>
       <td width="50%" align="left"><asp:Label ID="lblAmt" runat="server" Visible="false"></asp:Label></td>
       </tr> 
       <tr><td colspan="2">&nbsp;</td></tr>
      </table>
      ...
      <table border="0" cellpadding="1" cellspacing="0" align="center" width="90%">
       <tr><td colspan="2">&nbsp;</td></tr>
       <tr>
       <td width="100%" align="center" colspan="2"><asp:Label ID="lblMsg" runat="server" Font-Bold="true" Font-Names="verdana" Font-Size="16px" ForeColor="White"></asp:Label></td>
       </tr>  
       <tr><td colspan="2">&nbsp;</td></tr>       
      </table>
